...
//	Route::post('fjmy/search', 'FJMYController@searchPost');//查询POST
	...
	Route::post('member/sendVertifyCode', 'MessageController@sendVertifyCode')->middleware('throttle:1,1');//发送验证码 限制一分钟请求一次 已录入
	...
	Route::get('businesscard/getAvatarByUserid', 'BussinessCardController@getAvatarByUserid');//用户头像
