        ...
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            @foreach($datas as $index=>$data)
                <tr class="text-c">
                    ...
                    <td>@foreach(explode(',',$data->types) as $type)
                            @if($type==0)
                    ...
                    <td>
                        <a style="text-decoration:none"
                           onclick="admin_add('编辑广告位','{{ URL::asset("adplace_edit?pid=").$data->pid}}','800','500')"
                           href="javascript:;" title="编辑">编辑</a>
                        <a href="{{ URL::asset("ads?pid=").$data->pid}}" title="查看广告">查看广告</a>
