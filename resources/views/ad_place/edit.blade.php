    ...
    <form class="form form-horizontal" id="form-article-add" method="post">
        ...
        <div class="row cl hidden">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$data->pid?$data->pid:''}}" placeholder=""
                       id="pid" name="pid">
            </div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">允许的类型：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <label for="type0"> <input id="type0" type="checkbox" name="types[]" value="0" {{substr_count($data->types,'0')?'checked="checked"':''}}>图片</label>
                <label for="type1"> <input id="type1" type="checkbox" name="types[]" value="1" {{substr_count($data->types,'1')?'checked="checked"':''}}>名片</label>
                <label for="type2"> <input id="type2" type="checkbox" name="types[]" value="2" {{substr_count($data->types,'2')?'checked="checked"':''}}>信息</label>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    @if($data->icon_path==''||$data->icon_path==null)
                    ...
                    @else
                        <div id="fileList" class="uploader-list">
                            <div id="file.id'" class="item">
                                <div class="pic-box" id="filePicker"><img src='{{$data->icon_path}}'></div>
                                <div class="info"></div>
                            </div>
                            <input class="hidden" name="icon_path" value="{{$data->icon_path}}"/>
                        </div>
