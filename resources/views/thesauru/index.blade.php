    ...
    <div class="page-container">
        <form>
            <div class="text-c">
                ...
                <a class="btn btn-success radius r btn-refresh"
                   style="line-height:1.6em;margin-top:3px" id="refresh"
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a class="btn btn-primary radius" onclick="admin_add('添加','{{ URL::asset("thesauru_edit")}}','800','500')">
                <i class="Hui-iconfont">&#xe600;</i> 添加同义词</a>
                </span>
                ...
                <tr class="text-c">
                    ...
                    <td>
                        <a style="text-decoration:none"
                           onclick="admin_add('编辑','{{ URL::asset("thesauru_edit?id=").$data->id}}','800','500')"
    ...
    <script type="text/javascript">
        $('.table-sort').dataTable({
            ...
            "aoColumnDefs": [
                ...
                {"orderable": false, "aTargets": [2, 1]}// 不参与排序的列
            ]
        });
