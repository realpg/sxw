...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>VIP级别：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" step="1" min="1" max="99" class="input-text" value="{{$data->vip?$data->vip:''}}" placeholder=""
                       id="articletitle2" name="vip">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" step="1" min="0" class="input-text" value="{{$data->druation?$data->druation/86400:''}}" placeholder=""
                       id="articletitle2" name="druation"><span class="ml-5 f-14"><strong>天</strong></span>
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>价格（积分）：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" step="1" min="0" class="input-text" value="{{$data->amount?$data->amount:''}}" placeholder=""
